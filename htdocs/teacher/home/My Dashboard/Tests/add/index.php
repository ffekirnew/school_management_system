...
<body>
	...
	<main>
		<div class="index-banner">
        	<nav><h2>Fill The Informations About The Test</h2></nav>
        	<article>
        	<form action="includes/signup.inc.php" method="post">
            	<input type="text" name="name" placeholder="Test Name"><br>
            	<input type="text" name="type" placeholder="Test Type"><br>
            	<input type="text" name="subject" placeholder="Subject"><br>
            	<input type="text" name="weight" placeholder="Test Weight"><br>
